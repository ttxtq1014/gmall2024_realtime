...
import com.personal.realtime_common.bean.TableProcessDim;
...
public class JdbcUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String sql = " select `source_table` , `sink_table` , `sink_family` , `sink_columns`, `sink_row_key` from gmall2024_config.table_process_dim" ;
